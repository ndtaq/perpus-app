                ...
                <form method="post">
                    ...
                    $id = $_GET['id'];
                        if (isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "UPDATE buku SET judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', kategori_id='$kategori_id', deskripsi='$deskripsi' WHERE buku_id=$id");
